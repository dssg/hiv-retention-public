drop table if exists features_cdph.dx_status cascade;

create table features_cdph.dx_status as
with dx_status as (
select
"EHARSID",
dx_status,
...
create index on features_cdph.dx_status(entity_id);
create index on features_cdph.dx_status(knowledge_date_col);
